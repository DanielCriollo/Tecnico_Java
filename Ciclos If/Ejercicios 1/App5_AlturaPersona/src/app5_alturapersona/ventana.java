...
public class ventana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Altura Pesona");

        jLabel2.setText("Ingrese la altura de la persona");
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        if (altura <= 150) {
            ...
            viewResultado.setText("Persona de altura baja");

        } else if (altura >= 151 && altura <= 170) {

            viewResultado.setText("Persona de altura media");

        } else if (altura >= 171) {
            viewResultado.setText("Persona alta");
